...
\begin{tabular}{@{}cllll@{}}
\toprule
\multicolumn{1}{l}{\multirow{2}{*}{$N$}} & \multirow{2}{*}{Algoritmo} & \multicolumn{3}{l}{\begin{tabular}[c]{@{}l@{}}Recompensa promedio durante los últimos $E$\\ episodios de entrenamiento\end{tabular}} \\ \cmidrule(l){3-5} 
\multicolumn{1}{l}{} &  & Uno a uno & Causa común & Efecto común \\ \midrule
\multirow{4}{*}{5} & Q-learning &  &  &  \\
 & Q-learning + $\mathcal{D}$ &  &  &  \\
 & Q-learning + $\mathcal{D'}$ &  &  &  \\
 & Q-learning + $\mathcal{D''}$ &  &  &  \\ \midrule
\multirow{4}{*}{7} & Q-learning &  &  &  \\
 & Q-learning + $\mathcal{D}$ &  &  &  \\
 & Q-learning + $\mathcal{D'}$ &  &  &  \\
 & Q-learning + $\mathcal{D''}$ &  &  &  \\ \midrule
\multirow{4}{*}{9} & Q-learning &  &  &  \\
 & Q-learning + $\mathcal{D}$ &  &  &  \\
 & Q-learning + $\mathcal{D'}$ &  &  &  \\
